...
export default function HandleCLSCDHAIndex() {
                ...
                <div class="card-body">
                    ...
                    <div className="d-sm-flex flex-row d-block align-items-center">
                        <form action="" method="get" className="d-flex flex-row align-items-center">
                            ...
                            <Link to="/His/clscdharequest" className="btn btn-primary ms-2"><i className="fa-solid fa-rotate-right"></i></Link>
                        </form>
                                        ...
                                        return (
                                            <tr key={item.servicerequestdetailid}>
                                                ...
                                                <td className="align-middle" style={{ minWidth: '110px', width: '110px' }}>
                                                    <Link to={`/his/clscdharequest/detail/${item.servicerequestdetailid}`} className="btn btn-primary mx-1 px-2 py-1"><i className="fa-regular fa-edit fs-6"></i></Link>
