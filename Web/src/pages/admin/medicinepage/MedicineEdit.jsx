...
export default function MedicineEdit() {
    ...
    async function getMedicine() {
        try {
            const res = await Medicine.getDetail(id);
    ...
    const updateMedicine = async (e) => {
        ...
        e.preventDefault();
        try {
            const response = await Medicine.update(medicineData, id);
    ...
    return (
        <>
            ...
            <form className="pb-2" onSubmit={updateMedicine}>
                <div className="row">
                    <div className="col-12 col-md-6">
                        ...
                        <div className="py-1">
                            ...
                            <select
                                ...
                                name="dosageformid"
                                value={medicineData.dosageformid}
                                onChange={handleChangeInput}
                                required
                            >
                        ...
                        <div className="py-1">
                            ...
                            <select
                                className="form-select border-primary"
                                name="manufacturerid"
                                value={medicineData.manufacturerid}
                                onChange={handleChangeInput}
                                required
                            >
                                <option value="">-- Chọn dạng bào chế --</option>
