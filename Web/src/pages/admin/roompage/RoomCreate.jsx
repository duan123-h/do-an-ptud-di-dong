...
export default function RoomCreate() {
  ...
  async function getListDepartment() {
    ...
    const postRoom = async (e) => {
        ...
        e.preventDefault();
        try {
            const response = await Room.create(roomData);
                ...
                <div className="row">
                    <div className="col-12">
                        ...
                        <div class="py-1">
                            ...
                            <select onChange={handleChangeInput} class="form-select border-primary" name="Isactive" aria-label="Default select example">
